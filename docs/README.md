...
| `human_webots_testing.md` | 人类守着 Webots 跑一轮、记录肉眼现象 | 需要真实上车验证时 |
| `ai_offline_review.md` | AI 用 telemetry、控制日志、相机帧和 overlay 诊断一轮 run | 人类跑完后复盘机制 |

## 推荐阅读顺序

1. 新接手：先读 `experiments/STATUS.md`，再回到根目录 `README.md`。
2. 要跑 Webots：读 `human_webots_testing.md`。
